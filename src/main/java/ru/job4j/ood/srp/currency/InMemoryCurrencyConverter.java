...
public class InMemoryCurrencyConverter implements CurrencyConverter {
    ...
    public InMemoryCurrencyConverter() {
        ...
        this.conversationTable[Currency.RUB.ordinal()][Currency.EUR.ordinal()] = 0.0199;
        this.conversationTable[Currency.USD.ordinal()][Currency.EUR.ordinal()] = 0.9191;
        this.conversationTable[Currency.USD.ordinal()][Currency.RUB.ordinal()] = 91D;
        this.conversationTable[Currency.EUR.ordinal()][Currency.USD.ordinal()] = 1.0879;
